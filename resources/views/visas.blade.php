                                ...
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm h-100">
                                        ...
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'Dubai', 'image' => 'https://images.unsplash.com/photo-1526495124232-a04e1849168c?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80']) }}" class="btn btn-primary mt-auto">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm h-100">
                                        ...
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'Singapore', 'image' => 'https://plus.unsplash.com/premium_photo-1697730373939-3ebcaa9d295e?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8c2luZ2Fwb3JlfGVufDB8fDB8fHww']) }}" class="btn btn-primary mt-auto">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm h-100">
                                        ...
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'Malaysia', 'image' => 'https://images.unsplash.com/photo-1508062878650-88b52897f298?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8bWFsYXNpYXxlbnwwfHwwfHx8MA%3D%3D']) }}" class="btn btn-primary mt-auto">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm h-100">
                                        ...
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'Thailand', 'image' => 'https://images.unsplash.com/photo-1528181304800-259b08848526?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1974&q=80']) }}" class="btn btn-primary mt-auto">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm h-100">
                                        ...
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'Vietnam', 'image' => 'https://images.unsplash.com/photo-1738706863635-c024fd3616a9?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MTF8fHZpdGVuYW0lMjBjaXR5fGVufDB8fDB8fHww']) }}" class="btn btn-primary mt-auto">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                ...
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm h-100">
                                        ...
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'Indonesia', 'image' => 'https://images.unsplash.com/photo-1559628209-54d638b6137a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8aW5kb25lc2lhfGVufDB8fDB8fHww']) }}" class="btn btn-primary mt-auto">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm h-100">
                                        ...
                                        <div class="card-body d-flex flex-column">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'Turkey', 'image' => 'https://images.unsplash.com/photo-1562632259-34a8932b2a4a?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8dHVya2V5fGVufDB8fDB8fHww']) }}" class="btn btn-primary mt-auto">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'Egypt', 'image' => 'https://images.unsplash.com/photo-1568322445389-f64ac2515020?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8ZWd5cHR8ZW58MHx8MHx8fDA%3D']) }}" class="btn btn-primary">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'Schengen', 'image' => 'https://images.unsplash.com/photo-1587742812943-f149a4133a77?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Mnx8c2NoZW5nZW58ZW58MHx8MHx8fDA%3D']) }}" class="btn btn-primary">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'USA', 'image' => 'https://images.unsplash.com/photo-1508672019048-805c876b67e2?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8dXNhfGVufDB8fDB8fHww']) }}" class="btn btn-primary">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'Canada', 'image' => 'https://images.unsplash.com/photo-1503614472-8c93d56e92ce?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8Y2FuYWRhfGVufDB8fDB8fHww']) }}" class="btn btn-primary">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'UK', 'image' => 'https://images.unsplash.com/photo-1569865867048-34cfce8d58fe?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8OHx8VUt8ZW58MHx8MHx8fDA%3D']) }}" class="btn btn-primary">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'Australia', 'image' => 'https://images.unsplash.com/photo-1508672019048-805c876b67e2?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8dXNhfGVufDB8fDB8fHww']) }}" class="btn btn-primary">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'New Zealand', 'image' => 'https://plus.unsplash.com/premium_photo-1661962302792-4b05d3e08513?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8MXx8TmV3JTIwWmVhbGFuZHxlbnwwfHwwfHx8MA%3D%3D']) }}" class="btn btn-primary">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'Japan', 'image' => 'https://images.unsplash.com/photo-1524413840807-0c3cb6fa808d?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8Nnx8amFwYW58ZW58MHx8MHx8fDA%3D']) }}" class="btn btn-primary">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'South Korea', 'image' => 'https://images.unsplash.com/photo-1538485394074-f9f4d8434b06?w=500&auto=format&fit=crop&q=60&ixlib=rb-4.1.0&ixid=M3wxMjA3fDB8MHxzZWFyY2h8NHx8U291dGglMjBLb3JlYXxlbnwwfHwwfHx8MA%3D%3D']) }}" class="btn btn-primary">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                ...
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'Argentina']) }}" class="btn btn-primary">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'Mexico']) }}" class="btn btn-primary">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'Colombia']) }}" class="btn btn-primary">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'Peru']) }}" class="btn btn-primary">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'Chile']) }}" class="btn btn-primary">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'South Africa']) }}" class="btn btn-primary">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'Morocco']) }}" class="btn btn-primary">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'Kenya']) }}" class="btn btn-primary">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'Tanzania']) }}" class="btn btn-primary">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'Nigeria']) }}" class="btn btn-primary">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                                <div class="col-md-4">
                                    <div class="card mb-4 shadow-sm">
                                        ...
                                        <div class="card-body">
                                            ...
                                            <a href="{{ route('visa.show', ['country' => 'Ghana']) }}" class="btn btn-primary">Apply Now</a>
                                        </div>
                                    </div>
                                </div>
                            </div>
